...
parser.add_argument('--proto', type=str, default='FaceMaskDetection_dnn/models/face_mask_detection.prototxt',
                    help='prototxt path')
parser.add_argument('--model', type=str, default='FaceMaskDetection_dnn/models/face_mask_detection.caffemodel',
                    help='model path')
...
if __name__ == "__main__":
    ...
    imag = cv2.imdecode(
        np.fromfile(r'C:\Users\17293\Desktop\电子竞赛\project-face_recognition\models\叶建成\main.jpg', dtype=np.uint8), 1)
    result = inference(Net, imag, target_shape=(260, 260))
